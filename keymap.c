...
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  KC_LCTL, KC_LGUI, _______, KC_LALT, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_RALT, _______, _______, KC_RCTL    \
),
...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  _______, KC_LEFT, KC_DOWN, KC_RIGHT,_______, _______, KC_DOT,  KC_4,    KC_5,    KC_6,    KC_MINS, KC_SLSH, \
...
[_RAISE] = LAYOUT_preonic_grid( \
  ...
  _______, KC_PAST, KC_PMNS, KC_PPLS,  KC_PEQL, KC_LBRC, KC_RBRC, KC_UNDS, KC_PSLS, KC_PIPE, KC_BSLS, _______, \
